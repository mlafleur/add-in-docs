...
|:-----|:-----|:-----|:-----|
| _fileType_|[FileType](../../reference/shared/filetype-enumeration.md)|Specifies the format in which the file will be returned. Required.<br/><table><tr><th>Host</th><th>Supported fileType</th></tr><tr><td>Excel Online</td><td>Office.FileType.Compressed</td></tr><tr><td>PowerPoint on Windows desktop</td><td>Office.FileType.CompressedOffice.FileType.Pdf</td></tr><tr><td>Word on Windows desktop and iPad</td><td>Office.FileType.CompressedOffice.FileType.PdfOffice.FileType.Text</td></tr><tr><td>Word Online</td><td>Office.FileType.CompressedOffice.FileType.PdfOffice.FileType.Text</td></tr><tr><td>PowerPoint Online</td><td>Office.FileType.CompressedOffice.FileType.Pdf</td></tr></table>|**Changed in** 1.1, see [Support history](#support-history)|
